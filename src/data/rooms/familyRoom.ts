...
export const familyRoom: Room = {
  ...
  hotspots: [
    ...
    { kind: 'decoration', id: 'tv', zone: { x: 320, y: 95, w: 100, h: 98 }, lines: ['Static... Static...', "Nothing good is on."], sfx: 'click' },
    { kind: 'decoration', id: 'couch', zone: { x: 425, y: 185, w: 94, h: 95 }, lines: ['Comfy!'], sfx: 'boing' },
    { kind: 'decoration', id: 'armchair', zone: { x: 255, y: 195, w: 90, h: 90 }, lines: ['Bouncy checkered chair!'], sfx: 'boing' },
    { kind: 'decoration', id: 'fireplace', zone: { x: 215, y: 150, w: 90, h: 40 }, lines: ['No fire today. Too warm!'], sfx: 'click' },
